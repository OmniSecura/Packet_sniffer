...
#include "src/statistics/charts/barchart.h"
...
static constexpr auto qt_meta_stringdata_ZN8BarChartE = QtMocHelpers::stringData(
    "BarChart"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN8BarChartE[] = {
...
Q_CONSTINIT const QMetaObject BarChart::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN8BarChartE.offsetsAndSizes,
    qt_meta_data_ZN8BarChartE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN8BarChartE_t,
        // Q_OBJECT / Q_GADGET
...
void *BarChart::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN8BarChartE.stringdata0))
